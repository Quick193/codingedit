    ...
    <div className="max-w-md mx-auto bg-white p-6 rounded-xl shadow-sm border border-gray-100">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div>
          ...
          <input name="name" value={form.name} onChange={handleChange} required className="w-full border border-gray-200 rounded-md px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-teal-500" />
        </div>
        <div>
        ...
        <button type="submit" className="bg-teal-600 text-white px-4 py-2 rounded-md font-semibold hover:bg-teal-700 w-full">Sign up</button>
      </form>
